...
1	HJFC	vendor@vendor.com	Finger Licking Good!	68 Orchard Rd, Plaza Singapura, #B1-21/22, Singapore 238839	vendor/1
2	Mom's Kitchen	slypoon@gmail.com	Take a break from your busy business schedules or need a boost before heading back to your school works or simply just enjoying a leisurely family outing; do drop by here to enjoy a great bowl of your favourite dessert. In Mom's Kitchen, we remain committed to serve fresh and tasty desserts. And we stay open every day to serve to all our customers’ needs. So come visit us soon.	5 Cross St, Unit 01-30, Singapore 048418	vendor/2
3	Purple Sage	purple@purple.com	Purple Sage cooks a range of delicious dishes from fresh, local produce. Using a high level of technical skill, they are able to achieve fusion of flavours by taking a modern twist on traditional recipes. Their food contains only the finest, natural ingredients and contains less oil & less salt.	157 Pandan Loop, Singapore 128355	vendor/3
4	Broth Asia	broth@broth.com	Broth Asia soup makes you feel warm inside. Happy, safe, comforted, and at home. Each one is unique, an expression of the culture that inspired it and the home cooking that created it.	252 North Bridge Road, #B1-62 Rafffles City Shopping Centre, 179103, 179103	vendor/4
