...
2	Mom's Kitchen	wewong.2018@smu.edu.sg	Take a break from your busy business schedules or need a boost before heading back to your school works or simply just enjoying a leisurely family outing; do drop by here to enjoy a great bowl of your favourite dessert. In Mom's Kitchen, we remain committed to serve fresh and tasty desserts. And we stay open every day to serve to all our customers’ needs. So come visit us soon.	5 Cross St, Unit 01-30, Singapore 048418	vendor/2
3	Purple Sage	bellelee51196@gmail.com	Purple Sage cooks a range of delicious dishes from fresh, local produce. Using a high level of technical skill, they are able to achieve fusion of flavours by taking a modern twist on traditional recipes. Their food contains only the finest, natural ingredients and contains less oil & less salt.	157 Pandan Loop, Singapore 128355	vendor/3
